...
insert into patient(pat_num, pat_name,pat_age,pat_gender,pat_id) values('123456789', 'John Doe', 18, 'm', 'P4');

insert into patient(pat_num, pat_name,pat_age,pat_gender,pat_id) values('987654321', 'Jane Doe', 19, 'f', 'P5');